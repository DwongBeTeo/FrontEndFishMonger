...
const AquariumPage = () => {
    // --- CẤU HÌNH CỐ ĐỊNH CHO TRANG BỂ CÁ ---
    const AQUARIUM_CATEGORY_ID = 7; 
    ...
    const fetchProductsByCategory = async (pageNo) => {
        ...
        try {
            ...
            // Gọi API với ID cố định là 7
            const res = await axiosConfig.get(API_ENDPOINTS.GET_ALL_PRODUCTS_BY_CATEGORY(AQUARIUM_CATEGORY_ID), { params });
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            ...
            <div className="mb-8 text-center">
                <h1 className="text-3xl font-bold text-gray-800 uppercase">Bể Cá Cảnh & Setup</h1>
